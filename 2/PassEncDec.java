...
public class PassEncDec
{
    ...
    private char   matrix_arr[][] = new char[9][9];
...
//            letter = 'i';
    ...
    {
    	PassEncDec x = new PassEncDec();
        Scanner sc = new Scanner(System.in);
        System.out.println("Enter a keyword:");
//        String keyword = sc.next();
        String keyword = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789@#~`!$%^&*-_+{}:?<>";
        x.setKey(keyword);
        x.KeyGen();
//        System.out.println("Enter word to encrypt: (Make sure length of message is even)");
//        String key_input = sc.next();
        String key_input = "hqz";
        System.out.println("INPUT :: "+key_input);
        ...
        {	
        	key_input =key_input.trim()+"z";
        	String coded = String.valueOf(x.decryptMessage(String.valueOf(x.encryptMessage(key_input))));
        	...
        	System.out.println("Encryption: " + x.encryptMessage(key_input));
            System.out.println("Decryption: "                    + coded);
